...
if (isset($_POST["btipo"])) {
    ...
    $mysql->conecta();
    $ptipo = $_POST['ftipo'];
    $query = $mysql->query("update tbproduto set tipo='$ptipo' where id=$id");
    if ($query) {
        echo "<script>alert('Tipo alterado com sucesso!'); window.location.href='pesquisa.php';</script>";
    } else {
...
<head>
<meta charset="UTF-8">
<title>Moranguete Doces &mdash; Alterar Tipo</title>
...
<div class="card">
  ...
  <form name="tipo" action="?id=<?php echo htmlspecialchars($id_param); ?>" method="POST">
    <label for="ftipo">Novo tipo</label>
    <select name="ftipo" id="ftipo">
      <option value="alimento">&#127852; Alimento</option>
      <option value="bebida">&#129380; Bebida</option>
    </select>
    <button type="submit" name="btipo" class="btn btn-primary">Salvar altera&ccedil;&atilde;o &rarr;</button>
  </form>
